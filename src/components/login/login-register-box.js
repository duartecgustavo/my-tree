        ...
        <RegisterAreaStyle>
            <div className="container">
                <div className="row div-row">
                    ...
                    <Section className="col-12 col-lg-6">
                        <h3>Registre-se</h3>
                        <p style={{ color: `${Colors.BLACK_GRAY}` }}>Preencha os campos abaixo para se registrar.</p>
                        <form>
                            <div class="mb-3">
                            ...
                            <div className="mb-3">
                                ...
                                <input type="tel" className="form-control" id="exampleInputPassword1" placeholder="Telefone" />
                            </div>
                            <div className="mb-3">
                                <label className="form-label">Digite sua data de nascimento</label>
                            ...
                            <button className="btn btn-secondary" onClick={() => { setView(true) }}>Voltar ao login</button>
                        </form>
                    </Section>
                </div>
            </div>
